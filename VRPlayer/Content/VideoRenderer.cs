...
namespace VRPlayer.Content
{
    ...
    internal class VideoRenderer : Disposer
    {
        ...
        public void Render()
        {
            ...
            if (!this.loadingComplete || mediaPlayer == null)
            {
                return;
            }

            mediaPlayer.OnRender();
        ...
        public void InitializeMediaPlayer()
        {
            try
            {
                ...
                mediaPlayer.Initialize(deviceResources.D3DDevice);
                mediaPlayer.Load();
            }
            catch (Exception e)
            {
        ...
        public void FastForward(double skipTs)
        {
            mediaPlayer.FastForward(100 * skipTs);
            mediaPlayer.Play();
        }
    }
}
