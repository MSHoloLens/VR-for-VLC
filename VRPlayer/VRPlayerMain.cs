...
namespace VRPlayer
{
    ...
    /// </summary>
    internal class VRPlayerMain : IDisposable
    {
        ...
        public VRPlayerMain(DeviceResources deviceResources)
        {
        ...
        {
            Debug.WriteLine("VRPlayer.VRPlayerMain.OnDeviceRestored");
            videoRenderer.CreateDeviceDependentResourcesAsync();
        }

        void OnLocatabilityChanged(SpatialLocator sender, Object args)
        {
            Debug.WriteLine("VRPlayer.VRPlayerMain.OnLocatabilityChanged");
        ...
        {
            Debug.WriteLine("VRPlayer.VRPlayerMain.OnCameraAdded");
        ...
        {
            Debug.WriteLine("VRPlayer.VRPlayerMain.OnCameraRemoved");
            Task task2 = new Task(() =>
            {
                //
